...
<?php
/**
 * WordPress 內置嵌套評論專用 Ajax comments >> WordPress-jQuery-Ajax-Comments v1.29 by Willin Kan.
 *
...
//以下是评论式样, 不含 "回复". 
?>
<li id="comment-<?php comment_ID() ?>" class="comment-body comment-body-loading">
   <div id="div-comment-<?php comment_ID() ?>">
      <?php $add_below = 'div-comment'; ?>
		<div class="comment-author vcard">
<?php 
echo get_avatar( $comment, 50 );?>
<cite class="fn"><?php comment_author_link() ?></cite><?php edit_comment_link('编辑','&nbsp;&nbsp;',''); ?></div>
		<?php if ( $comment->comment_approved == '0' ) : ?>
			<span style="color:#C00; font-style:inherit">您的评论正在等待审核中...</span>
			<br />			
		<?php endif; ?>
        <div class="comment-meta"><span class="datetime"><?php comment_date('Y-m-d') ?>  <?php comment_time() ?> </span> 
          		<?php comment_text() ?>
